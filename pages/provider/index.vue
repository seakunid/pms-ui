...
export default {
    ...
    methods: {
        ...
        getDataPackets() {
            ...
            axios.get(`https://seakun-packet-api-v2.herokuapp.com/${this.provider.toLowerCase()}`)
            .then(res => {
        ...
        changeStatusPacket(packet) {
            ...
            axios.patch(`https://seakun-packet-api-v2.herokuapp.com/${this.provider.toLowerCase()}/${packet.id}`, payload)
            .then(res => {
